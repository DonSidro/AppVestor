...
public class UserDetailsTask {

    private final String TAG = UserDetailsTask.class.getSimpleName();
     ...
     * @param context
     */
    public UserDetailsTask(final Context context) {
    ...
    public void WalletRequest(final String userID, WalletInterface walletInterface){
        ...
        String url = "https://staging-my.appvestor.com/api/userdetails?userid="+ userID;
